...
import { Sling as Hamburger } from "hamburger-react"; // ✅ Ensure you install this
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center justify-center gap-[1rem] mr-10 my-2">
        ...
        <NavLink
          to="/Events"
          className="relative w-fit font-semibold text-lightgray text-[1.2rem] md:text-[1.4rem] tracking-[-1.5px] leading-[28px] whitespace-nowrap pr-4"
        >
          Events
        </NavLink>
      </div>
